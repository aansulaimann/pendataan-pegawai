   ...
   <!-- main bar  -->
      <div class="col-12 col-lg">
         <div class="row">
            ...
            <div class="col mt-3">
               <a href="tambah.php" class="btn btn-primary btn-lg shadow">Tambah data Jabatan</a>
            </div>
         </div>
         <div class="row me-2">
            <div class="col">
               <table class="table border">
                  ...
                  <?php $i = 1; foreach($jabatan as $row) : ?>
                     <tr>
                        ...
                        <td>
                           <a href="#" class="badge bg-info me-2 p-2" onclick="window.open('detail.php?id=<?php echo $row['Id']; ?>', 'newwindow', 'width=600,height=300, top=140, left=300', 'titlebar=0'); return false;">detail</a>
                           <a href="delete.php?id=<?php echo $row['Id']; ?>" onclick="return confirm('yakin hapus data?');" class="badge bg-danger me-2 p-2">delete</a>
                           <a href="#" onclick="window.open('update.php?id=<?php echo $row['Id']; ?>', 'newwindow', 'width=800,height=800, top=300, left=300'); return false;" class="badge bg-success me-2 p-2">update</a>
                        </td>
                     </tr>
                  <?php endforeach; ?>
                  </tbody>
